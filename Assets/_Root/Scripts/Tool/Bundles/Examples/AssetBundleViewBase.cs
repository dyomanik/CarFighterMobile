...
namespace Tool.Bundles.Examples
{
    ...
    {
        private const string UrlAssetBundleSprites = "https://drive.google.com/uc?export=download&id=1Nd64s8bBqXA-aAubvR2l7aCgIHyDbc9H";
        private const string UrlAssetBundleAudio = "https://drive.google.com/uc?export=download&id=1KibqCKwo7dJPcx5GwtC_D99tXEMQfnb6";
